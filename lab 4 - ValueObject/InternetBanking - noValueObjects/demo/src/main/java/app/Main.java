    ...
    public static void main(String[] args) throws SQLException {
        ...
        var app = Javalin.create(config -> {
            ...
            .post("/accounts", ctx -> {
                ...
                if (req.currency == "USD") repo.createUSDAccount(req.id, req.owner, req.initialAmount);
                else if (req.currency == "RUB") repo.createRUBAccount(req.id, req.owner, req.initialAmount);
